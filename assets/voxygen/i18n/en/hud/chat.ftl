...
hud-chat-meta-group-invite-full = Invite failed: your group is full ({ $max } players).
hud-chat-meta-invite-target-missing = Invite failed: target does not exist.
hud-chat-meta-invite-pending = This player already has a pending invite.
hud-chat-meta-invite-not-player = Can't invite: not a player or NPC.
hud-chat-meta-group-kick-target-missing = Kick failed: target does not exist.
hud-chat-meta-group-kick-pet = Kick failed: you can't kick pets.
hud-chat-meta-group-kick-self = Kick failed: you can't kick yourself.
hud-chat-meta-group-kick-not-leader = Kick failed: you are not the leader of the target's group.
hud-chat-meta-group-kick-target-not-in-group = Kick failed: your target is not in a group.
hud-chat-meta-group-removed = You were removed from the group.
hud-chat-meta-group-kick-success = Player kicked.
hud-chat-meta-group-leader-now = You are the group leader now.
hud-chat-meta-group-leader-no-longer = You are no longer the group leader.
hud-chat-meta-group-leader-transfer-target-missing = Leadership transfer failed: target does not exist.
hud-chat-meta-group-leader-transfer-not-leader = Transfer failed: you are not the leader of the target's group.
hud-chat-meta-group-leader-transfer-target-not-in-group = Transfer failed: your target is not in a group.
hud-chat-meta-trade-inviter-new-trade = Trade failed: inviter initiated a new trade since sending the trade request.
