...
hud-items_lost_dur = Seus itens equipados perderam Durabilidade.
hud-items_will_lose_dur = Seus itens equipados perderão Durabilidade.
hud-hardcore_char_deleted = Este personagem hardcore foi excluído.
hud-hardcore_will_char_deleted = Este personagem hardcore será excluído.
hud-press_key_to_respawn = Pressione { $key } para renascer na última fogueira visitada.
hud-press_key_to_give_up = Segure { $key } para desistir e morrer.
hud-press_key_to_return_to_char_menu = Pressione { $key } para voltar ao menu de personagens.
hud-downed_recieving_help = Recebendo ajuda.
...
hud-steal-requires = Roubar com { $item }
hud-unlock-consumes = Use { $item } para abrir
hud-steal-consumes = Use { $item } para roubar
hud-mine = Minerar
hud-dig = Cavar
...
hud-stay = Ficar
hud-sit = Sentar
hud-waypoint_interact = Definir Ponto de Referência
hud-steer = Guiar
hud-rest = Descansar
hud-portal = Portal
