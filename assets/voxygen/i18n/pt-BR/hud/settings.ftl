...
hud-settings-draggable_windows = Janelas arrastáveis
...
hud-settings-use_health_prefixes = Usar prefixos SI na barra de vida
...
hud-settings-colored_player_marker = Marcador Colorido de Jogador
...
hud-settings-lock_chat = Travar Tamanho/Posição do Chat
hud-settings-chat_character_name = Nomes de Personagem no chat
hud-settings-show_chat_timestamp = Mostrar Carimbos de Hora no Chat
...
hud-settings-instrument_volume = Volume de Instrumentos
hud-settings-ambience_volume = Volume Ambiente
hud-settings-rain_ambience = Ambiente de Chuva
hud-settings-indoor_ambience = Detecção de Ambiente Interno
...
hud-settings-sfx_channels = Capacidade de Canais SFX
hud-settings-sfx_channels_low = Baixo
hud-settings-sfx_channels_med = Médio
...
hud-settings-show_all_recipes = Mostrar Todas as Receitas
hud-settings-gamepad = Controle
hud-settings-keyboard = Teclado
hud-settings-keyboard-binding = Atalhos
hud-settings-game_buttons = Botões do Jogo
hud-settings-game_layers = Camadas do Jogo
hud-settings-menu_buttons = Botões do Menu
hud-settings-row_background_opacity = Opacidade de Fundo da Linha