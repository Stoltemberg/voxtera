...
main-singleplayer-map_shape-square = Quadrado
...
main-credits-sound = Som
main-credits-fonts = Fontes
main-credits-other_art = Outras Artes
main-credits-contributors = Contribuidores
loading-tips =
    .a0 = Pressione '{ $gameinput-togglelantern }' para acender sua lanterna.
    .a1 = Pressione '{ $gameinput-controls }' para ver todos os atalhos padrão.
    .a2 = Digite /say ou /s para conversar apenas com jogadores ao seu redor.
    .a3 = Digite /region ou /r para conversar com jogadores a algumas centenas de blocos ao seu redor.
    .a4 = Administradores podem usar o comando /build para entrar no modo de construção.
    .a5 = Digite /group ou /g para conversar apenas com jogadores do seu grupo atual.
    .a6 = Para enviar mensagens privadas, digite /tell seguido do nome do jogador e sua mensagem.
    .a7 = Fique atento a comida, baús e outros itens espalhados pelo mundo!
    .a8 = Inventário cheio de comida? Tente criar comida melhor com ele!
    .a9 = Querendo saber o que fazer? Experimente uma das masmorras marcadas no mapa!
    .a10 = Não se esqueça de ajustar os gráficos para o seu sistema. Pressione '{ $gameinput-settings }' para abrir as configurações.
    .a11 = Jogar com outros é divertido! Pressione '{ $gameinput-social }' para ver quem está online.
    .a12 = Pressione '{ $gameinput-dance }' para dançar. Festa!
    .a13 = Pressione '{ $gameinput-glide }' para abrir seu Planador e conquistar os céus.
    .a14 = O Voxtera ainda está em Pre-Alfa. Fazemos o nosso melhor para melhorá-lo todos os dias!
    .a15 = Se você quer se juntar à equipe de desenvolvimento ou apenas conversar conosco, entre no nosso servidor Discord.
    .a16 = Você pode ativar a exibição da sua quantidade de vida na barra de vida nas configurações.
    .a17 = Sente-se perto de uma fogueira (com a tecla '{ $gameinput-sit }') para se recuperar lentamente dos seus ferimentos.
    .a18 = Precisa de mais bolsas ou armadura melhor para continuar sua jornada? Pressione '{ $gameinput-crafting }' para abrir o menu de criação!
    .a19 = Pressione '{ $gameinput-roll }' para rolar. Rolar pode ser usado para se mover mais rápido e esquivar de ataques inimigos.
    .a20 = Querendo saber para que serve um item? Pesquise 'input:<nome do item>' na criação para ver em quais receitas ele é usado.
    .a21 = Você pode tirar capturas de tela com '{ $gameinput-screenshot }'.